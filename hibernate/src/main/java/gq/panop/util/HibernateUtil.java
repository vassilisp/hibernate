...
public class HibernateUtil {
	...
	public static int hqlCreatePreProcessTable(String myTable){
	    ...
	    hql += "( "
	            ...
	            + " targetID VARCHAR(20),"
	            + " refererID1 VARCHAR(20),"
                + " targetID1 VARCHAR(20),"
                + " refererID2 VARCHAR(20),"
                + " targetID2 VARCHAR(20),"
                + " refererID3 VARCHAR(20),"
                + " targetID3 VARCHAR(20),"
                + " refererID4 VARCHAR(20),"
                + " targetID4 VARCHAR(20),"
